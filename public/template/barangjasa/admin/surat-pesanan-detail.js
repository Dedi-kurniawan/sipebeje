...
var table = $('#datatable').DataTable({
    ...
    ajax: {
        method: 'POST',
    	url: HOST_URL + '/dt/admin/master/surat-pesanan-detail',
        data: function (d) {
            d.surat_pesanan_id = $("#surat_pesanan_id").val();
        }
    },
    columns: [{
            data: 'DT_RowIndex',
...
$("#submitData").click(function (event) {
    ...
    var url = HOST_URL + '/admin/surat-pesanan-detail';
...
$(document).on('click', '#deleteData', function (e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            var action = "delete";
            $.ajax({
                url: HOST_URL + '/admin/surat-pesanan-detail/' + id,
                method: "DELETE",
                dataType: 'json',
                success: function (d) {
                    finishLoading();
