...
var table = $('#datatable').DataTable({
    ...
    ajax: {
        method: 'POST',
    	url: HOST_URL + '/dt/admin/master/ba-barang-detail',
        data: function (d) {
            d.ba_barang_id = $("#ba_barang_id").val();
        }
    },
    columns: [{
            data: 'DT_RowIndex',
...
$("#submitData").click(function (event) {
    ...
    var url = HOST_URL + '/admin/ba-barang-detail';
...
$(document).on('click', '#deleteData', function (e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            var action = "delete";
            $.ajax({
                url: HOST_URL + '/admin/ba-barang-detail/' + id,
                method: "DELETE",
                dataType: 'json',
                success: function (d) {
                    finishLoading();
