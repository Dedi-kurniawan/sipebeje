                    ...
                    <div class="card-body p-4">
                        <div class="text-center w-75 m-auto">
                            <div class="auth-logo">
                                ...
                                <a href="#" class="logo logo-light text-center">
                                    <span class="logo-lg">
                                        <img src="{{ asset('template/images/logo/logo-light.png') }}" alt=""
                                            height="30">
                                    </span>
                                </a>
                            </div>
                        ...
                        <div class="mt-3 text-center">
                            <svg version="1.1" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
                                ...
                                y="0px" viewBox="0 0 98 98" style="height: 120px;" xml:space="preserve">
                                <style type="text/css">
                                    .st0 {
                                        fill: #FFFFFF;
                                    }
                            ...
                            <h3>Success !</h3>
                            <p class="text-muted font-14 mt-2">Hallo {{ $user->name }}, Link Verifikasi sudah terkirim ke <b>{{ $user->email }}</b>. Silahkan di cek dan klik link tertera pada email </p>
                                <form action="{{ route('frontend.confirm.email.post', $user->confirm_url) }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <input class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" readonly type="hidden" placeholder="Email" name="email" value="{{ $user->email }}" autocomplete="off" />
                                    </div>
                                    <div class="form-group d-flex flex-wrap">
                                        <button type="submit" class="btn w-100 btn-success waves-effect waves-light mt-3">Kirim Ulang Link Verifikasi</button>
                                        <a href="{{ route('frontend.login') }}" class="btn w-100 btn-pink waves-effect waves-light mt-3">Login</a>
                                    </div>
                                </form>
                        </div>
                    </div>
