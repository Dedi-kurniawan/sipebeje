                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('nomor') ? 'is-invalid' : '' }}" maxlength="100" autocomplete="off" name="nomor" value="{{ old('nomor', $paket->evaluasiPenawaran->nomor) }}"  id="nomor" title="kolom nomor di larang kosong" placeholder="Nomor surat BA Evaluasi Harga..." required/>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="kegiatan" class="form-control {{ $errors->has('kegiatan') ? 'is-invalid' : '' }}" cols="30" rows="3" disabled placeholder="Kegiatan..." disabled required>{{ $paket->evaluasiPenawaran->kegiatan == NULL ? $paket->nama : old('kegiatan', $paket->evaluasiPenawaran->kegiatan) }}</textarea>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="tahun_anggaran" id="tahun_anggaran" disabled class="form-control selectFormClass {{ $errors->has('tahun_anggaran') ? 'is-invalid' : '' }}" required>
