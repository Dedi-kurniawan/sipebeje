    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{-- {{ $errors }} --}}
                    <form id="form_validate" method="POST" action="{{ route('admin.vendor.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="nama" value="{{ old('name') }}" required placeholder="Nama">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email" value="{{ old('email') }}" required placeholder="E-mail">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" id="password" required placeholder="password" minlength="8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <input type="hidden" id="desa_selected" value="{{ old('desa_id') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="npwp" type="text" class="form-control {{ $errors->has('npwp') ? 'is-invalid' : '' }}" id="npwp" value="{{ old('npwp') }}" placeholder="NPWP" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="telepon" type="number" class="form-control {{ $errors->has('telepon') ? 'is-invalid' : '' }}" id="telepon" value="{{ old('telepon') }}" placeholder="Telepon" required>
